...
INSERT INTO product (id, create_by, create_date, last_update, last_update_by, blog_post_id,  name, price, quantity, is_sales, short_description, slug, thumbnail_url, group_id) VALUES	('p3', 'SYSTEM', NOW(), NOW(), 'SYSTEM', '',  'Product 3', 22.22, 3, true, '', 'product-3', 'thumb-3', 'g2');
...
INSERT INTO public.product_attribute (id, create_by, create_date, last_update, last_update_by, description, name, status) VALUES	('att2', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Product Attribute 2', 'Att - 2', 'DISABLED');
INSERT INTO public.product_attribute (id, create_by, create_date, last_update, last_update_by, description, name, status) VALUES	('att3', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Product Attribute 3', 'Att - 3', 'ENABLED');
INSERT INTO public.product_attribute (id, create_by, create_date, last_update, last_update_by, description, name, status) VALUES	('att4', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Product Attribute 4', 'Att - 4', 'REMOVED');


INSERT INTO public.product_attribute_value (id, create_by, create_date, last_update, last_update_by, value, product_id, attribute_id) VALUES  ('av1', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Value 1', 'p1', 'att1');
INSERT INTO public.product_attribute_value (id, create_by, create_date, last_update, last_update_by, value, product_id, attribute_id) VALUES	('av2', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Value 2', 'p2', 'att4');
INSERT INTO public.product_attribute_value (id, create_by, create_date, last_update, last_update_by, value, product_id, attribute_id) VALUES	('av3', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Value 3', 'p2', 'att3');
INSERT INTO public.product_attribute_value (id, create_by, create_date, last_update, last_update_by, value, product_id, attribute_id) VALUES	('av4', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Value 4', 'p1', 'att2');
INSERT INTO public.product_attribute_value (id, create_by, create_date, last_update, last_update_by, value, product_id, attribute_id) VALUES	('av5', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Value 5', 'p3', 'att2');
...
INSERT INTO public.product_option (id, create_by, create_date, last_update, last_update_by, description, display_type, name) VALUES	('o1', 'SYSTEM', NOW(), NOW(), 'SYSTEM', '', 'number', 'option 1');
INSERT INTO public.product_option (id, create_by, create_date, last_update, last_update_by, description, display_type, name) VALUES	('o2', 'SYSTEM', NOW(), NOW(), 'SYSTEM', '', 'color', 'option 2');
INSERT INTO public.product_option (id, create_by, create_date, last_update, last_update_by, description, display_type, name) VALUES	('o3', 'SYSTEM', NOW(), NOW(), 'SYSTEM', '', 'number', 'option 3');


INSERT INTO public.product_option_value (id, create_by, create_date, last_update, last_update_by, value, product_id, product_option_id) VALUES	('ov1', 'SYSTEM', NOW(), NOW(), 'SYSTEM', 'Option Value 1', 'p1', 'o1');
