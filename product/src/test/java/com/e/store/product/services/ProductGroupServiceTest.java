...
public class ProductGroupServiceTest {
    ...
    void deleteGroup_shouldSuccess_whenDataValid() {
        mockProductGroup.setProductList(Arrays.asList());
        ProductGroup newGroup = ProductGroup.builder().name("new test").build();
    ...
    void getAllGroupTest() {
        ...
        Page<ProductGroup> productGroups = new Page<ProductGroup>() {
            @Override
        ...
        when(iProductGroupRepository.findByCreatorWithPagination(any(), any())).thenReturn(productGroups);
        ResponseEntity<ListProductGroupResVm> res = this.productGroupService.getAllGroup(1);
        Assertions.assertNotNull(res);
        Assertions.assertNotNull(res.getBody());

        ListProductGroupResVm listProductGroupResVm = res.getBody();
        Assertions.assertEquals(3, listProductGroupResVm.totalPages());
        Assertions.assertEquals(25, listProductGroupResVm.totalGroup());
    }
}
