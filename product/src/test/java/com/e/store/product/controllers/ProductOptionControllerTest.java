...
class ProductOptionControllerTest extends AbstractControllerTest {
    ...
    void createNewOption_whenDataInvalid() throws Exception {
        ...
        MvcResult result = mockMvc.perform(
                MockMvcRequestBuilders.post("/api/v1/product/option").contentType(MediaType.APPLICATION_JSON)
                    .accept(MediaType.APPLICATION_JSON_VALUE).content(this.mapToJson(productOptionCreateReqVm)))
            .andReturn();
    ...
    void createNewOption_whenDataValid() throws Exception {
        ...
        Assertions.assertTrue(
            result.getResponse().getContentAsString()
                .startsWith("{\"status\":\"CREATED\",\"message\":\"Create new option successfully - id: "
                    ));
    }
    ...
    void getOptionTest() throws Exception {
        MvcResult result = mockMvc.perform(
            MockMvcRequestBuilders.get("/api/v1/product/option").contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON_VALUE).param("page", "1")).andReturn();

        Assertions.assertEquals(200, result.getResponse().getStatus());
        ListProductOptionResVm listProductOptionResVm = this.mapFromJson(result.getResponse().getContentAsString(),
            ListProductOptionResVm.class);
        Assertions.assertEquals(3, listProductOptionResVm.totalOptions());
    ...
    void getAllOptionTest() throws Exception {
        MvcResult result = mockMvc.perform(
            MockMvcRequestBuilders.get("/api/v1/product/option/all").contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();

        Assertions.assertEquals(200, result.getResponse().getStatus());
        CommonProductResVm[] listCommon = this.mapFromJson(result.getResponse().getContentAsString(),
    ...
    void updateOption_whenOptionIdInvalid() throws Exception {
        productOptionCreateReqVm = new ProductOptionCreateReqVm("option 4", "", "");
        MvcResult result = mockMvc.perform(
            MockMvcRequestBuilders.put("/api/v1/product/option/ooop1").accept(MediaType.APPLICATION_JSON_VALUE)
                .contentType(MediaType.APPLICATION_JSON).content(this.mapToJson(productOptionCreateReqVm))).andReturn();
    ...
    void updateOption_whenDataValid() throws Exception {
        productOptionCreateReqVm = new ProductOptionCreateReqVm("option 4", "", "");
        MvcResult result = mockMvc.perform(
            MockMvcRequestBuilders.put("/api/v1/product/option/o1").accept(MediaType.APPLICATION_JSON_VALUE)
                .contentType(MediaType.APPLICATION_JSON).content(this.mapToJson(productOptionCreateReqVm))).andReturn();
    ...
    void deleteOption_whenOptionInUse() throws Exception {
        MvcResult result = mockMvc.perform(
                MockMvcRequestBuilders.delete("/api/v1/product/option/o1").accept(MediaType.APPLICATION_JSON_VALUE))
            .andReturn();
    ...
    void deleteOption_whenOptionNotUse() throws Exception {
        MvcResult result = mockMvc.perform(
                MockMvcRequestBuilders.delete("/api/v1/product/option/o2").accept(MediaType.APPLICATION_JSON_VALUE))
            .andReturn();
