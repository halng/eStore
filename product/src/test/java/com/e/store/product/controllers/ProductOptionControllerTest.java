...
class ProductOptionControllerTest extends AbstractControllerTest {
	...
	void createNewOption_whenDataInvalid() throws Exception {
		...
		MvcResult result = mockMvc
			.perform(MockMvcRequestBuilders.post("/api/v1/product/option")
	...
	void getOptionTest() throws Exception {
		MvcResult result = mockMvc
			.perform(MockMvcRequestBuilders.get("/api/v1/product/option")
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON_VALUE)
				.param("page", "1"))
			.andReturn();
		...
		PagingResVm<ProductOptionResVm> listProductOptionResVm = this
			.mapFromJson(result.getResponse().getContentAsString(), PagingResVm.class);
	...
	void getAllOptionTest() throws Exception {
		MvcResult result = mockMvc
			.perform(MockMvcRequestBuilders.get("/api/v1/product/option/all")
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON_VALUE))
			.andReturn();
	...
	void updateOption_whenOptionIdInvalid() throws Exception {
		productOptionCreateReqVm = new ProductOptionCreateReqVm("option 4", "", "");
		MvcResult result = mockMvc
			.perform(MockMvcRequestBuilders.put("/api/v1/product/option/ooop1")
				.accept(MediaType.APPLICATION_JSON_VALUE)
				.contentType(MediaType.APPLICATION_JSON)
				.content(this.mapToJson(productOptionCreateReqVm)))
			.andReturn();
	...
	void updateOption_whenDataValid() throws Exception {
		productOptionCreateReqVm = new ProductOptionCreateReqVm("option 4", "", "");
		MvcResult result = mockMvc
			.perform(MockMvcRequestBuilders.put("/api/v1/product/option/o1")
				.accept(MediaType.APPLICATION_JSON_VALUE)
				.contentType(MediaType.APPLICATION_JSON)
				.content(this.mapToJson(productOptionCreateReqVm)))
			.andReturn();
		...
		Assertions.assertEquals(200, result.getResponse().getStatus());
		Assertions.assertEquals(
				"{\"status\":\"OK\",\"message\":\"Update option option 4"
						+ " successfully\",\"logMessage\":\"200 OK - Update option option 4 successfully\"}",
				result.getResponse().getContentAsString());
	}
	...
	void deleteOption_whenOptionNotUse() throws Exception {
		...
		Assertions.assertEquals(200, result.getResponse().getStatus());
		Assertions.assertEquals(
				"{\"status\":\"OK\",\"message\":\"Delete option option 2"
						+ " successfully\",\"logMessage\":\"200 OK - Delete option option 2 successfully\"}",
				result.getResponse().getContentAsString());
	}
