...
public class ProductAttributeServiceImpl implements IProductAttributeService {
    ...
    public ResponseEntity<ResVm> createNewAttribute(
        ...
        ProductAttribute newProductAttribute = this.iProductAttributeRepository.save(
            productAttribute);
                ...
                .orElseThrow(
                    () ->
                        new EntityNotFoundException(
                            String.format(
                                "Product Attribute with id: %s does not exist! Pls try again!",
                                id)));
    ...
    public ResponseEntity<ResVm> deleteAttribute(String attId) {
        LOG.info(
            String.format("Receive request to delete status for attribute have id: %s", attId));
        ProductAttribute productAttribute = getById(attId);
