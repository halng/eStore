    ...
    CommandLineRunner run(
        ...
        return args -> {
            ...
            Role adminRole = roleRepository.save(
                Role.builder().roleName(AccountRole.ADMIN).build());
            Role superRole = roleRepository.save(
                Role.builder().roleName(AccountRole.SUPERADMIN).build());
            Role sellerRole = roleRepository.save(
                Role.builder().roleName(AccountRole.SELLER).build());
