...
public class AuthController {
    ...
    public ResponseEntity<?> activeAccount(@PathVariable String accountId) {
        return authService.activeAccount(accountId);
    }

    @PutMapping("/{accountId}/update")
    public ResponseEntity<?> updateAccount(@PathVariable String accountId, @RequestBody AccountInfoVm updateData) {
        return authService.updateAccount(accountId, updateData, null);
    }

    @PostMapping("/refresh-token")
    public ResponseEntity<RefreshTokenResVm> refreshToken(@RequestBody RefreshTokenReqVm refreshTokenReqVm) {
        return authService.refreshToken(refreshTokenReqVm);
    }
