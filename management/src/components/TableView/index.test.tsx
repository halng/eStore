...
describe('Test Rendering', () => {
    it('renders a heading', () => {
        render(
            <TableView
                tableData={mockProductGroupData}
                tableHeader={PRODUCT_GROUP_TABLE_HEADER}
                setOpenAction={null}
            />,
        )
    ...
    it('renders a when missing data', () => {
        render(<TableView tableData={null} tableHeader={PRODUCT_GROUP_TABLE_HEADER} setOpenAction={null} />)

        const noData = screen.getByText('No Data!')
        expect(noData).toBeInTheDocument()
    })
    it('renders a when empty data', () => {
        render(<TableView tableData={[]} tableHeader={PRODUCT_GROUP_TABLE_HEADER} setOpenAction={null} />)
