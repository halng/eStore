...
import { ProductOptionType, ProductOptionCreateType } from '../../types/ProductOptionType'
...
const ProductOption = () => {
    ...
    const updateOption = (e: any, data: ProductOptionCreateType, option: ProductOptionType) => {
        if (!data.description) {
