                ...
                {category === "option" && (
                  <>
                    <div>
                      ...
                      >
                        <option
                          selected={item.displayType === "color"}
                          value="color"
                        >
                          Color
                        </option>
                        <option
                          selected={item.displayType === "number"}
                          value="number"
                        >
                          Number
                        </option>
                        <option
                          selected={item.displayType === "text"}
                          value="text"
                        >
                          Text
                        </option>
              ...
              <div className="modal-footer">
                {category === "group" && (
                  <button
                    ...
                    data-bs-dismiss="modal"
                    onClick={(e) =>
                      onChangeGroupStatusHandler(e, item.id, item.status)
                    }
                  >
                ...
                <th
                  ...
                  className={
                    firstRow[index].fieldName.toString() === "status"
                      ? `text-${item[
                          firstRow[index].fieldName.toString()
                        ].toLowerCase()}`
                      : ""
                  }
                >
